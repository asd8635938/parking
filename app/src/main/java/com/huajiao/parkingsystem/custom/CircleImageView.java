package com.huajiao.parkingsystem.custom;
...
public class CircleImageView extends AppCompatImageView {
        ...
        private int mBorderColor = Color.parseColor("#45d8a3");//描边颜色
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (mBorderWidth > 0) {
                canvas.drawCircle((width / 2)+mBorderWidth, (height / 2)+mBorderWidth, radius, mBorderPaint);
                   }
        }
